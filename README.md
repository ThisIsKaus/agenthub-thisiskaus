...
_Generated from the live machine 2026-07-29T21:45. Do not edit by hand._
...
- A knowledge base of many chunks across many documents, indexed from OneDrive
...
Using the preceding AgentHub context, build "AgentHub Remote" — a private, single-user

companion for a personal AI operations hub. Dark, editorial, data-dense. Not a SaaS

landing page. Mobile-first: this lives on a phone.

DESIGN, apply exactly:

- Background #0B0B0D, panels #141416, hairline borders #26262A (1px, never shadows)

- Copper #C8744A for accents and active states only — never as a fill for large areas

- Text #ECEBE8 primary, #8E8E96 secondary, #5E5E66 tertiary

- Status: #7FA88C ok, #C9A227 watch, #B5544A risk — muted, never neon

- Google Fonts: Instrument Serif (headings only), Inter 300/400/500 (body),

  Geist Mono (every number, timestamp, status pill)

- Border radius 2px maximum. No gradients, no glassmorphism, no card shadows.

AUTH via Supabase:

- Email magic link only. No password. No public sign-up.

- Restrict to one address held in a Supabase secret ALLOWED_EMAIL. Any other address is

  refused at sign-in with "This instance is private."

- Signed-out view is a single card: title in Instrument Serif, one email field, one

  button. No marketing copy, no feature list, no footer links.

- Enable row-level security on every table.

LAYOUT: sticky header with title and a row of monospace status pills. Tab bar beneath.

Content max-width 1100px. Create five empty tabs: Overview, Capture, Digest, Factory, Cost.

This project was built with [Lovable](https://lovable.dev).

## Build with Lovable

Continue developing this project in the [Lovable editor](https://lovable.dev/projects/a973cba5-7074-421e-a575-fa57185c3659).
